    ...
    init: function () {
      ...
      supabase.auth.onAuthStateChange(function (event, session) {
        ...
        if (event === 'SIGNED_IN' || event === 'TOKEN_REFRESHED' || event === 'INITIAL_SESSION') {
          // v2.6.86 — Demo seed cleanup on actual sign-in. Boot'ta demo
          // workspace + içeriği seed ediliyor. Sign-in'de bu lokal demo,
          // gerçek cloud verisinin üzerine push edilmesin diye sıfırlanır.
