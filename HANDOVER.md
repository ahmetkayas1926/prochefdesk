...
**Mevcut sürüm:** **v2.11.10** (push'a hazır local; production v2.11.9). **Recipe Tags "+ Add 'X'" CTA chip** (mouse-only friendly — Enter şart değil, suggestion'da yeşil vurgulu CTA tıklanarak yeni tag eklenir). 1 yeni i18n key × 2 dil.
...
| Production sürümü | **v2.11.10** (push'a hazır local; production v2.11.9) |
