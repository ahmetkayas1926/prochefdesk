...
**Mevcut sürüm:** **v2.9.22** (push'a hazır local; production v2.9.21). KC "Hide used" checkbox state persist fix.
...
| Production sürümü | **v2.9.22** (push'a hazır local; production v2.9.21) |
