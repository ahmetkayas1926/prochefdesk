...
**Mevcut sürüm:** **v2.11.6** (push'a hazır local; production v2.10.4). Whiteboard Block Composer (v2.11.0-2) + Discover search (v2.11.3) + Kitchen Cards WYSIWYG (v2.11.4) + Popup footer overlay fix (v2.11.5) + **HACCP form typography uniformity** (v2.11.6 — Logs ve Receiving Cook & Cool kanonuna çekildi: padding 3px4px / line-height 1.3 / row 20px / letter-spacing 0.03em; Holding zaten kanondaydı).
...
| Production sürümü | **v2.11.6** (push'a hazır local; production v2.10.4) |
