...
Bu Claude'un yaptıkları (kronolojik tersine). **v2.15.0–v2.15.2 commit edildi ama operatör HENÜZ PUSH ETMEDİ** ("2.14.6 hala push etmedim" demişti — 2.14.7→2.15.4 büyük tek bundle bekliyor). **v2.15.3 + v2.15.4 commit de edilmedi — working tree'de.**
