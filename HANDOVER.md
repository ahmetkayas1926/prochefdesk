...
**Mevcut sürüm:** **v2.9.32** (push'a hazır local; production v2.9.31). **HACCP Cook & Cool print single-page guarantee fix** — v2.9.31 pilot 3 sayfa oldu, A4 landscape body sized + compact footer override pattern uygulandı.
...
| Production sürümü | **v2.9.32** (push'a hazır local; production v2.9.31) |
