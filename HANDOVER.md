...
**Mevcut sürüm:** **v2.11.11** (push'a hazır local; production v2.11.10). **Discover search debounce 200ms → 400ms** (operatör: 1 kelime yazamadan hemen filter çalışıyordu). Tek satır fix.
...
| Production sürümü | **v2.11.11** (push'a hazır local; production v2.11.10) |
